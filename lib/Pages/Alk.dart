    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            "assets/pozadine/alkoholna.jpeg", // Replace with the path to your background image
            fit: BoxFit.cover,
            ...
            builder: (context, cafeSnapshot) {
              ...
              return StreamBuilder<QuerySnapshot>(
                stream: cafeDoc.reference
                    ...
                    .where("Kategorija",
                        isEqualTo:
                            "Alkoholna pica") // Adjust the category as needed
                    .snapshots(),
                        ...
                        return Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              color: const Color.fromARGB(255, 175, 91, 30)
          ...
          Padding(
            ...
            child: AppBar(
              ...
              title: Text(
                "Alkoholna pica", // Changed text here
                style: GoogleFonts.poppins(
                  color: Colors.white,
                  fontSize: 24,
              ...
              child: Padding(
                ...
                child: Center(
                  child: Text(
                    ...
                    "Naša paleta alkoholnih pića pruža izvanredan ukus i eleganciju u svakoj čaši. 🍻",
                    style: GoogleFonts.poppins(
                      color: Colors.white,
                      fontSize: 16,
                    ),
